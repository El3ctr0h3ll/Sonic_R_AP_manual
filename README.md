...
- Codes to use (sonic r mod manager pc version):
  Unlock All Characters, Stages, and Emeralds and Practice Mode (Tokens/Emeralds Always Spawn)
 Also Gems Collection Cursor Speeds for Q.O.L

recommended Mods:
Remove Stay UI Pixels,
Saturn Style Colouring,
EggRobo Texture Fix

# Goal
Get first place in Radiant Emerald with all Chaos Emeralds
